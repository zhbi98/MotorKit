...
int cmd_vbus_voltage();
int cmd_dev_config(char * str_p);
int cmd_axis_requested_state(int motor_id, int _state);
...
#endif
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC),
                   vbus_voltage, cmd_vbus_voltage, vbus_voltage),
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC),
                   dev_config, cmd_dev_config, dev_config),
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC),
                   axis_requested_state, cmd_axis_requested_state, axis_requested_state),
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC),
                   controller_config_control_mode, cmd_axis_controller_config_control_mode, config_control_mode),
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC),
                   controller_config_vel_limit, cmd_axis_controller_config_vel_limit, config_vel_limit),
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC),
                   dc_max_negative_current, cmd_config_dc_max_negative_current, dc_max_negative_current),
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC),
                   dump_errors, dumperrors, dump_error),
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC),
                   controller_input_pos, cmd_axis_controller_input_pos, controller_input_pos),
    SHELL_CMD_ITEM(SHELL_CMD_PERMISSION(0)|SHELL_CMD_TYPE(SHELL_TYPE_CMD_FUNC),
